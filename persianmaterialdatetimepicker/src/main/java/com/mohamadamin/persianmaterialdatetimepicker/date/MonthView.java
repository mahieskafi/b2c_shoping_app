...
public abstract class MonthView extends View {
  ...
  public MonthView(Context context, AttributeSet attr, DatePickerController controller) {
    ...
    if (darkTheme) {
      mDayTextColor = res.getColor(R.color.mdtp_date_picker_text_highlighted_dark_theme);
    ...
    mSelectedDayTextColor = res.getColor(R.color.mdtp_numbers_text_color);
    mTodayNumberColor = res.getColor(R.color.mdtp_today_color);
    mMonthTitleColor = res.getColor(R.color.mdtp_numbers_text_color);

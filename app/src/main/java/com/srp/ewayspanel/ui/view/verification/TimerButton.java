...
//        }
    ...
    private void measureRelatedVars() {
        ...
        mTimeTextBounds.set(centerX-timeTextWidth/2, centerY - timeTextHeight / 2, centerX+timeTextWidth/2, centerY + timeTextHeight / 2);
    ...
    protected void onDraw(Canvas canvas) {
        if (mTimerIsFinished) {
            ...
            mTitlePaint.setColor(mBorderUnFinishedColor);
            canvas.drawText(mTitle, mButtonTitleBounds.left, mButtonTitleBounds.centerY() - mTitlePaintDeltaY, mTitlePaint);
...
//        String minuitRepresentation = minuit < 10 ? ("0" + minuit) : ("" + minuit);
        String secondRepresentation = second < 10 ? ("0"+minuit+":0" + second) : ("0"+minuit+":" + second);
